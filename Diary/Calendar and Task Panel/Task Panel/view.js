...
function getTimeline(tasks) {
	...
	for (i=0; i<timelineDates.length; i++) {
		...
		if (timelineDates[i] == today) {
			...
			todayContent += "<div class='left'><select class='fileSelect' aria-label='Select the note to add a task'></select><input class='newTask' type='text' placeholder='Enter task'/></div>"
